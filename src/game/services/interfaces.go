...
type AnimationInterface interface {
	...
	ActorEngagedIllegalAnimationForPlayer(player, victim *core.Actor, icon rune, actionPosition geometry.Point, timeNeededInSeconds float64, finishedCallback func(), cancelCallback func())
