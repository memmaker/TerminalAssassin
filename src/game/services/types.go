...
// AlarmTriggeredEvent is published when a guard activates an alarm object.
// SightingLocation is the dangerous sighting that prompted the alarm run.
type AlarmTriggeredEvent struct {
	SightingLocation geometry.Point
}
