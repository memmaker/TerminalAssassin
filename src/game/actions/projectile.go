...
func (p *Projectile) Update() {
    ...
    // Prevent self-damage: skip tiles occupied by the shooter themselves
    collideWithSource := currentMap.IsActorAt(currentPos) && currentMap.ActorAt(currentPos) == p.User
